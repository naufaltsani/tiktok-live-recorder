...
class TikTok:
    ...
    def get_room_and_user_from_url(self):
        ...
        try:
            ...
            response = self.httpclient.get(self.url, allow_redirects=False, headers=headers)
    ...
    def get_room_id_from_user(self) -> str:
        ...
        try:
            ...
            response = self.httpclient.get(f"https://www.tiktok.com/@{self.user}/live", headers=headers,
